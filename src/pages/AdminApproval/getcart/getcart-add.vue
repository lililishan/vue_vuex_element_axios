            ...
            <div class="apply-cont">
              <div style="background-color: white;">
                ...
                <div class="inp-container clearfix">
                  <div class="container-left">
                    <span class="left-name">出行时间<span style="color: red;">*</span></span>
                    <div>
                      <el-date-picker
                        v-model="startTime"
                        type="datetime"
                  ...
                  <div class="container-right">
                    <span class="left-name">还车时间<span style="color: red">*</span></span>
                    <div>
                      <el-date-picker
                        v-model="startTimeback"
                        type="datetime"
                        placeholder="选择日期时间">
                      </el-date-picker>
                    </div>
                ...
                <div class="inp-container clearfix">
                  <div class="container-left">
                    <span class="left-name">出发地<span style="color: red;">*</span></span>
                    <input type="text" class="yuans-inp">

                  </div>

                  <div class="container-right">
                    <span class="left-name">目的地<span style="color: red;">*</span></span>
                    <input type="text" class="yuans-inp">
                  </div>
                ...
                <div class="inp-container clearfix">
                  <div class="container-left">
                    <span class="left-name">用车人数<span style="color: red">*</span></span>
                ...
                <div class="inp-textarea clearfix" style="width: 100%">
                  <div class="container-left container-left" style="width: 100%">
                    <span class="left-name" style="width: 9.5%">
                      申请事由 <span style="color: red">*</span>
                    </span>
